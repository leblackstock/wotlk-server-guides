# Demonology Warlock Implementation Checklist
...
- [x] Verify 0/56/15 talent point total and calculator URL
...
- [x] Run node tools/audit-fresh-80-guide.mjs templates/spec-guide/demonology-warlock.config.json
- [x] Run node --check assets/demonology-warlock.js
- [x] Run node --check assets/warlock-tooltips.js
- [x] Run node tools/audit-playbook-ability-icons.mjs templates/spec-guide/demonology-warlock.config.json after the regular icon-density audit
...
- [x] Confirm every ability/action chip in every spec playbook card renders its own verified WoW icon
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/demonology-warlock.config.json` during drafting
- [x] Run `node tools/analyze-guide-icon-density.mjs --config templates/spec-guide/demonology-warlock.config.json --policy templates/spec-guide/icon-density-policy.json` while tuning visual density
- [x] Run `node tools/audit-playbook-ability-icons.mjs templates/spec-guide/demonology-warlock.config.json` after the regular icon-density audit
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/demonology-warlock.config.json --release`; this automatically enforces icon density first and playbook ability icons second
