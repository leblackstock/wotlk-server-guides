...
- [x] Run node --check assets/shadow-priest.js
...
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/shadow-priest.config.json` during drafting
- [x] Run `node tools/analyze-guide-icon-density.mjs --config templates/spec-guide/shadow-priest.config.json --policy templates/spec-guide/icon-density-policy.json` while tuning visual density
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/shadow-priest.config.json --release`; this automatically runs and enforces the rendered complexity-based icon audit
