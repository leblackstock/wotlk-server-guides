...
- [x] Run node --check assets/marksmanship-hunter.js
- [x] Run node --check assets/hunter-tooltips.js
...
- [x] Add all verified entities to data/hunter-entities.json
- [x] Rebuild assets/hunter-tooltips.js with `node tools/build-wowhead-tooltips.mjs data/hunter-entities.json assets/hunter-tooltips.js`
...
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/marksmanship-hunter.config.json` during drafting
- [x] Run `node tools/analyze-guide-icon-density.mjs --config templates/spec-guide/marksmanship-hunter.config.json --policy templates/spec-guide/icon-density-policy.json` while tuning visual density
- [x] Run `node tools/audit-spec-guide.mjs templates/spec-guide/marksmanship-hunter.config.json --release`; this automatically runs and enforces the rendered complexity-based icon audit
